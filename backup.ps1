...
#
# public/data holds 72 files, ~290 MB, of which 68 are the fast_*.json record
# exports carrying all 1,682,447 Nissan FAST records.
#
...
68 fast_*.json files holding all 1,682,447 Nissan FAST records. Those files
